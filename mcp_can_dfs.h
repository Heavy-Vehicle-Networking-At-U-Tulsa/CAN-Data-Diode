 ...
 */
#define MCP_NORMAL     0x04
#define MCP_SLEEP      0x24
#define MCP_LOOPBACK   0x44
#define MCP_LISTENONLY 0x64
#define MODE_CONFIG     0x84
...
#define MCP2515_SELECT()   digitalWrite(6, LOW)
#define MCP2515_UNSELECT() digitalWrite(6, HIGH)
